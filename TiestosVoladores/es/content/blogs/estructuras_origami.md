...
<p align = "center">
<img alt="Hábitat desplegable basado en origami." title="Hábitat desplegable basado en origami." data-src="/blogs/images/origami_habitat.webp" class="cld-responsive" style="max-width:80%; text-align: center; padding-bottom: 16px; display: block; margin: auto; {{ $style }}">
</p>
<p align = "center">
